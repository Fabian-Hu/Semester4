...
var saveComment = function() {
    ...
    fetch('http://localhost:8080/studboardREST/resources/comment/create', {
...
function loadComments() {
    urlParams = new URLSearchParams(window.location.search);
    fetch('http://localhost:8080/studboardREST/resources/comments?articleId=' + urlParams.get("id")).then(
        function(response) {
            let res = response.json();
            return res;
        }
