...
public class ExampleData {
    ...
    private ExampleData() {
        ...
        comments.add(new Comment(0, 0, "Endlich kann ich beim Kartoffelschälen Radio hören", "5", ""));
        comments.add(new Comment(1, 0, "Hoffentlich gibt es das auch bald für nen Spargelschäler", "4", ""));
        comments.add(new Comment(2, 1, "Ich kann deine Nummer nicht auf ICQ finden, ist die falsch geschrieben?", "2", ""));
        comments.add(new Comment(3, 2, "Ich finde, pink ist eine viel schönere Farbe als weiß!!!", "3", ""));
        comments.add(new Comment(4, 3, "Wo bleibt der Mülleimer für Browser Toolbars?", "3", ""));
        comments.add(new Comment(5, 3, "Natürlich vergessen die den Mülleimer für OpenOffice Dokumente, nur damit man Microsoft Office benutzt", "4", ""));
        comments.add(new Comment(6, 4, "Boah, das wird mir zu bunt!", "1", ""));
    }
