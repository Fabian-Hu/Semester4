...
function loadSpecialArticlesFromServer(article) {
    fetch('http://localhost:8080/studboardRESTReferenz/resources/history?count=0&type=' + article).then(
        function(response) {
...
function loadArticlesFromServer(num) {
    fetch('http://localhost:8080/studboardRESTReferenz/resources/history?count=' + num + '&type=all').then(
        function(response) {
