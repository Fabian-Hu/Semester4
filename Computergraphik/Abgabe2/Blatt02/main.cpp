...
void initQuad()
{
	...
	const std::vector<glm::vec3> colors = { { colorrgb.r,colorrgb.g,colorrgb.b }, { colorrgb.r,colorrgb.g,colorrgb.b }, { colorrgb.r,colorrgb.g,colorrgb.b }, { colorrgb.r,colorrgb.g,colorrgb.b } };
...
void setColor(){
	...
	HSV hsv;
	int farbnr;
	std::cout << "Waehle den Farbraum?" << std::endl << "1.RGB" << std::endl << "2.CMY" << std::endl << "3.HSV" << std::endl;
	std::cin >> farbnr;
	std::cout << "Geben Sie ihre Werte der Reihenfolge nach an:" << std::endl;
	switch (farbnr) {
	case 1:
		std::cin >> rgb.r;
		std::cin >> rgb.g;
